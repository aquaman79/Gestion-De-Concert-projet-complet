...
public class ConcertServiceImpl {
    ...
    private SalleRepository  salleRepository;
        ...
        public Concertdto saveConcert(Concertdto concertdto) {
           ...
           if(this.verifyGroupe(concertdto.getGroupe().getIdGroupe(),concert)==true) {
               this.concertMapper.saveGroupeintoConcert(concert,concertdto.getGroupe().getIdGroupe());
...
//                }
    ...
    public List<Concertdto> getAllConcert(){
        ...
        public Concertdto update(Concertdto concertdto,Long id ){
            ...
            Groupe groupe = this.groupeRepository.findById(concertdto.getGroupe().getIdGroupe()).orElseThrow(()->new EntityNotFoundException("groupe n'existe pas"));
